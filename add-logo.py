...
logo_size = 200
logo = Image.new('RGBA', (logo_size, logo_size), (253, 185, 39, 255))  # Yellow background
...
# Save logo
logo.save('/c/knosso/34wiki/data-outline/logo.png')
print("Logo created: /c/knosso/34wiki/data-outline/logo.png")
